...
def hook_block(uc, addr, size, user_data):
    #print(uc.mem_read(addr, size))
    if g_verbose:
        print (f">>> {addr:x} {bytes(uc.mem_read(addr, size)).hex():32} {instruction_table.get(addr, '---')}")
        print(f" {'rax':16} = {uc.reg_read(UC_X86_REG_RAX):016x}")
        print(f" {'rbx':16} = {uc.reg_read(UC_X86_REG_RBX):016x}")
        print(f" {'rcx':16} = {uc.reg_read(UC_X86_REG_RCX):016x}")
        print(f" {'rdx':16} = {uc.reg_read(UC_X86_REG_RDX):016x}")
        print(f" {'rdi':16} = {uc.reg_read(UC_X86_REG_RDI):016x}")
        print(f" {'rsi':16} = {uc.reg_read(UC_X86_REG_RSI):016x}")
        print(f" {'rbp':16} = {uc.reg_read(UC_X86_REG_RBP):016x}")
        print(f" {'rsp':16} = {uc.reg_read(UC_X86_REG_RSP):016x}")
        print(f" {'r8 ':16} = {uc.reg_read(UC_X86_REG_R8):016x}")
        print(f" {'r9 ':16} = {uc.reg_read(UC_X86_REG_R9):016x}")
        print(f" {'r10':16} = {uc.reg_read(UC_X86_REG_R10):016x}")
        print(f" {'r11':16} = {uc.reg_read(UC_X86_REG_R11):016x}")
        print(f" {'r12':16} = {uc.reg_read(UC_X86_REG_R12):016x}")
        print(f" {'r13':16} = {uc.reg_read(UC_X86_REG_R13):016x}")
        print(f" {'r14':16} = {uc.reg_read(UC_X86_REG_R14):016x}")
        print(f" {'r15':16} = {uc.reg_read(UC_X86_REG_R15):016x}")
        print(f" {'rip':16} = {uc.reg_read(UC_X86_REG_RIP):016x}")
        print(uc.mem_read(uc.reg_read(UC_X86_REG_RDI), 32).hex())
        input()
