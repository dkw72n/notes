    ...
    types:
      ...
      section_header:
        ...
        instances:
          ...
          strings:
            io: _root._io
            pos: _root.header.section_headers[linked_section_idx].ofs_body
            size: _root.header.section_headers[linked_section_idx].len_body
            type: strings_struct
            if: linked_section_idx != 0 and _root.header.section_headers[linked_section_idx].type == sh_type::strtab
        ...
        seq:
          - id: entries
            type:
              switch-on: _root.bits
              cases:
                'bits::b32': dynsym_section_entry32(_parent.strings._io)
                'bits::b64': dynsym_section_entry64(_parent.strings._io)
            repeat: eos
